...
ENV OPENWRT_SDK_ARCH armsr-armv7
ENV OPENWRT_SDK_URL https://downloads.openwrt.org/releases/23.05.1/targets/armsr/armv7/openwrt-sdk-23.05.1-armsr-armv7_gcc-12.3.0_musl_eabi.Linux-x86_64.tar.xz
